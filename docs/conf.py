...
project = u'vmcall'
copyright = u'2014, Adrian Seyboldt'
...
try:
    from vmcall import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'user_guide.tex', u'vmcall Documentation',
   u'Adrian Seyboldt', 'manual'),
]
